...
export default function Contact() {
	...
	return (
		<section
			id="contact"
			className="py-20 bg-blue-400 relative overflow-hidden"
			style={{
				background: `
				linear-gradient(rgba(60, 156, 215, 0.2), rgba(60, 156, 215, 0.2)),
				url('/images/contact_background.jpg') center/cover no-repeat
			`,
			}}
		>
						...
						>
							<div className="flex-1">
								<div className="relative mb-[18px]">
									...
									/>
									{errors.companyName && (
										<p className="absolute top-full left-0 text-red-300 text-[12px]">{errors.companyName}</p>
									)}
								</div>
							...
							<div className="flex-1">
								...
								{errors.inquiryTypes && <p className="text-red-300 text-[12px]">{errors.inquiryTypes}</p>}
							</div>
						</form>
					</div>

					<div id="contact-privacy-policy" className="flex justify-center mb-6">
